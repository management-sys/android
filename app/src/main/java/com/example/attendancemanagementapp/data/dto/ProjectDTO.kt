...
object ProjectDTO {
    ...
    data class AssignedPersonnelInfo(
        ...
        @Json(name = "inptHnfId")   val id: Long?           // 투입 인력 아이디
    )
    ...
    data class GetProjectStatusResponse(
        @Json(name = "totalCount")  val totalCnt: Int?,                     // 전체 프로젝트 개수
        ...
        @Json(name = "deptList")    val departments: List<DepartmentInfo>,  // (검색조건) 프로젝트에 참여한 부서 목록
        @Json(name = "prjcts")      val projects: ProjectStatusesInfo       // 프로젝트 목록
    )
    ...
    data class UpdateProjectRequest(
        ...
        @Json(name = "planBgnde")           val planStartDate: String? = "",                                    // 계획 시작일
        @Json(name = "planEndde")           val planEndDate: String? = "",                                      // 계획 종료일
        @Json(name = "inptHnfDetailList")    val assignedPersonnels: List<AssignedPersonnelInfo> = emptyList(), // 투입 인력 리스트
        @Json(name = "prjctNm")             val projectName: String = "",                                       // 프로젝트명
        @Json(name = "prjctRspnberId")      val managerId: String = "",                                         // 프로젝트 책임자 아이디
        @Json(name = "realBgnde")           val realStartDate: String? = "",                                    // 실제 시작일
        @Json(name = "realEndde")           val realEndDate: String? = "",                                      // 실제 종료일
