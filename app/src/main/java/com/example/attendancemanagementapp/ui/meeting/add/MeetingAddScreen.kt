...
import com.example.attendancemanagementapp.util.formatDate
...
/* 회의록 등록 카드 */
@Composable
private fun AddMeetingCard(meetingAddState: MeetingAddState, onEvent: (MeetingAddEvent) -> Unit) {
    Card(
...
/* 참석자 구분 선택 디알로그 */
@Composable
private fun AttendeeTypeDialog(
    onDismiss: () -> Unit,
    onClickConfirm: () -> Unit,
        ...
        Column(
            ...
            SearchBar(
                ...
                searchState = SearchState(
                    ...
                    onClickInit = { onEvent(MeetingAddEvent.ClickedSearchInit) }
                ),
                hint = "직원명"
            )
